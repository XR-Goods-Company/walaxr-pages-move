...
const socialLinks = [
  ...
  { icon: PinterestIcon, href: "https://www.pinterest.com/wala_xr/", label: "Pinterest", isCustom: true },
  { icon: SnapchatIcon, href: "https://www.snapchat.com/add/wala_xr", label: "Snapchat", isCustom: true },
  { icon: TikTokIcon, href: "https://tiktok.com/@wala_xr", label: "TikTok", isCustom: true },
  { icon: LinkedInIcon, href: "https://www.linkedin.com/company/xrgoodscompany/", label: "LinkedIn", isCustom: true },
];
